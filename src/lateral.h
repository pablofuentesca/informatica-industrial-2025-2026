...
public:
    Unicornio(float x, float y) : Lateral(x, y, 1, "../bin/imagenes/fotosjugadores/madridlateral.png")
    {
...
public:
    Basilisco(float x, float y) : Lateral(x, y, 2, "../bin/imagenes/fotosjugadores/atletilateral.png")
    {
